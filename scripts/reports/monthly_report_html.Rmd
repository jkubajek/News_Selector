...
load(paste0(working_dir, 
            "News_Selector/data/topics/monthly_topics_2019-01_singularity_penalty_01_512.RData"))
...
all_text <- readLines(paste0(working_dir, 'News_Selector/scripts/reports/input.md'),
          encoding = "UTF-8")
