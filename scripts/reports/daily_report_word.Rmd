...
.wykres <- plot_all_words_correlation(words_similarity_matrix, scale_font = c(14, 10), class_num = 6, min_association = quantile(words_similarity_matrix, quant),
                           lambda_daily_DF)
...
for(name in names(list_topics)){
    ...
    .wykres <- plot_topic_correlation(topic_words, words_similarity_matrix, scale_font = scale_font, class_num = 6, min_association = 0.4, lambda_daily_DF)
